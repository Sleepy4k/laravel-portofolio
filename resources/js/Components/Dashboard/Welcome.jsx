export default function Welcome({ user, laravel, php }) {
    return (
        <div className="relative flex items-top justify-center bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div className="flex justify-center pt-8 sm:justify-end sm:pt-0">
                    {user ? (
                        <span>
                            {transData("page.dashboard.welcome")}, {user.name}!
                        </span>
                    ) : (
                        <span>
